...
My code is procedural and uses a lot of global variables, but it works beautifully. If anybody is willing to take my code and port it to proper C++, please go ahead!
