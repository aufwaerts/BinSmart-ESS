...
void loop() {
    ...
    telnet.print(HIDE_CURSOR);  // discourage user input while system is busy
}
...
void SetNewPower() {
    ...
    // UVP mode and low PV production: enable sleep mode
...
void FinishCycle() {
    ...
    // Carry out one of the following maintenance tasks per cycle (one task max avoids overrun of PROCESSING_DELAY)
