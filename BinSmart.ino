...
void loop() {
    ...
    while (millis()-ts_power < max(PROCESSING_DELAY, !hm_power_limit * mwplug_eco_mode * UVP_SLEEP_DELAY))
...
void FinishCycle() {
    ...
    if (telnet) {
        ...
        cycle_msg += buf;
        cycle_msg += OPS_SYMBOL[!power_old + !hm_power_limit * mwplug_eco_mode];
        cycle_msg += "\r\n";
