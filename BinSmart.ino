...
void ProcessUserCommand() {
    ...
    switch (command) {
        ...
        case 'n':
            ...
            if ((en_pv_to_grid+en_pv_wasted > 1) && (en_pv_to_grid+en_pv_wasted < en_from_pv)) {
