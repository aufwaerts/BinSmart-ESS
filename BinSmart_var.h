...
float power_eff;  // DC/AC charging or AC/DC discharging power efficiency
float power_from_grid, power_to_grid, power_from_ess, power_to_ess, power_cons;  // main power flows
...
float en_from_pv = 0, en_pv_to_cons = 0, en_pv_to_ess = 0, en_pv_to_grid = 0, en_pv_wasted = 0;  // PV energy counters
float en_from_grid = 0, en_grid_to_cons = 0, en_grid_to_ess = 0;  // Grid energy counters
...
char cmd_resp[700], cycle_msg[300];  // output message strings
