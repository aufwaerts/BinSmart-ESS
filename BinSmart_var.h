...
unsigned long ts_cycle = 0, ts_power = 0, ts_pubip = 0, ts_EM_reset = 0;  // various timestamps
float max_secs_cycle = 0;  // longest measured cycle duration
int statechange_delay = 0;  // additional cycle delay in case charging/discharging state has changed
...
bool pm_eco_mode = true;  // eco mode of Shelly 1PM
