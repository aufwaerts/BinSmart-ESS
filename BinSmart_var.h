...
CRC8 crc8;
CRC16 crc16;
byte hm_switch_command[] = {0x51, HM_SN[2], HM_SN[3], HM_SN[4], HM_SN[5], 0x80, 0x17, 0x41, 0x72, 0x81, HM_TURNON, 0x00, 0x00, 0x00, 0x00};
byte hm_power_command[] = {0x51, HM_SN[2], HM_SN[3], HM_SN[4], HM_SN[5], 0x80, 0x17, 0x41, 0x72, 0x81, HM_POWERLIMIT, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
unsigned long start_uxt, minpower_uxt, errors_uxt, energy_uxt, shelly_uxt;  // unixtime of various events
...
int mw_limit = MW_MAX_POWER, mw_limit_old;  // Meanwell power limit settings
int hm_limit = HM_MAX_POWER, hm_limit_old;  // Hoymiles power limit settings
