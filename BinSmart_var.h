...
unsigned long pubip_time = 0, DDNS_time = 0;  // time of last public IP address update and last DDNS update
unsigned long ts_cycle = 0, ts_power = 0, ts_HM_ON = 0, ts_MW_ON = 0, ts_pubip = 0, ts_EM = 0, ts_EM_reset = 0;  // various timestamps

// Other global variables
String power_string = "0000", percent_string = "100.0 %";  // temp strings for formatting output with sprintf()
