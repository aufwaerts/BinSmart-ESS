...
// Hoymiles/RF24
byte hm_radio_ID[] = {0x01, 0xFF, 0xFF, 0xFF, 0xFF};  // 0xFF will be replaced by HM serial number
byte hm_turnon[] =  {0x51, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0x17, 0x41, 0x72, 0x81, 0x00, 0x00, 0xB0, 0x01, 0xD0};  // 0xFF will be replaced by HM serial number
byte hm_turnoff[] = {0x51, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0x17, 0x41, 0x72, 0x81, 0x01, 0x00, 0x20, 0x00, 0x40};  // 0xFF will be replaced by HM serial number
byte hm_power[] =   {0x51, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0x17, 0x41, 0x72, 0x81, 0x0B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};  // 0x00 will be replaced by calculation
...
int filter_cycles = POWERFILTER_CYCLES;  // for filtering out power spikes
