...
const unsigned int HTTP_TIMEOUT = 4000;  // max waiting time (in ms) for HTTP responses
const unsigned int HTTP_TIMEOUT_READIP = 1000;  // max waiting time (in ms) for HTTP read public IP response
