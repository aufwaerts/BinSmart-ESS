...
const int HM_MAX_POWER = -240;  // Hoymiles discharging power limit
...
const int MW_PLUG_MIN_DELAY = 4;  // min number of secs between two consecutive MW plug operations (prevents oscillation of MW plug)
