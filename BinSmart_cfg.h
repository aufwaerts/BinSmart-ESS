...
// BMS commands and data IDs
const byte BMS_VOLTAGES[] = {0x4E, 0x57, 0x00, 0x13, 0x00, 0x00, 0x00, 0x00, 0x03, 0x03, 0x00, 0x79, 0x00, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, 0x01, 0x9F};
const byte BMS_SETTINGS[] = {0x4E, 0x57, 0x00, 0x13, 0x00, 0x00, 0x00, 0x00, 0x06, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, 0x01, 0x29};
#define BMS_START_FRAME 0x4E57
#define BMS_ALLDATA 0x00
#define BMS_VCELLS 0x79
#define BMS_WARNINGS 0x8B
#define BMS_OVP 0x90
#define BMS_UVP 0x93
#define BMS_BAL_START 0x9B
#define BMS_BAL_TRIGGER 0x9C
